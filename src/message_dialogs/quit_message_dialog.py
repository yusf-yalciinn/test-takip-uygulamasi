...
class CustomizeQuitMessageBox(QDialog):
    def __init__(self):
        super(CustomizeQuitMessageBox, self).__init__()
        ...
        self.setWindowTitle(texts["title_exit"])
        self.setFixedSize(300, 150)
        self.ui.text.setText(texts["text_quit"])
