...
class Ui_Dialog(QFrame):
    def __init__(self, Dialog):
        ...
        self.remove.setGeometry(25, 200, 41, 31)
        self.remove.setCursor(self.cursor)
        self.remove.setFont(self.font)
        self.remove.setObjectName("remove_button")
    ...
    def text_func(self, Dialog):
        Dialog.setWindowTitle(texts["title_editing"])
        ...
        self.remove.setToolTip(texts["remove_button_tooltip"])
